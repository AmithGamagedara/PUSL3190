      ...
      <div className="flex items-center justify-between max-w-6xl px-6 py-3 mx-auto sm:px-10">
        <div className="flex items-center">
          ...
          <ul className="hidden gap-12 font-medium sm:flex">
            <li>
              <Link to="/" className="text-slate-50 hover:text-[#FF1616] duration-500">Home</Link>
            </li>
            <li>
              <Link to="/news" className="text-slate-50 hover:text-[#FF1616] duration-500">News</Link>
            </li>
            <li>
              <Link to="/events" className="text-slate-50 hover:text-[#FF1616] duration-500">Events</Link>
            </li>
            <li>
              <Link to="/ranking" className="text-slate-50 hover:text-[#FF1616] duration-500">Rankings</Link>
            </li>
            <li>
              <Link to="/learning" className="text-slate-50 hover:text-[#FF1616] duration-500">Learning</Link>
            </li>
          </ul>
        </div>
